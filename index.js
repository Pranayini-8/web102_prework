...
function addGamesToPage(games) {
    ...
    for(let game of games) {
        ...
        <p><strong>Pledged:</strong> $${game.pledged.toLocaleString()} of $${game.goal.toLocaleString()}</p>
...
const displayStr = 'A total of $' + totalRaised.toLocaleString() + ' has been raised for ' + totalGames + ' games. Currently, ' + numUnfundedGames + (numUnfundedGames === 1 ? ' game remains' : ' games remain') + ' unfunded. We need your help to fund these amazing games!';
...
console.log("Most Funded:", topGame.name);
console.log("Second Most Funded:", runnerUpGame.name);
console.log("Rest of Games:", rest);
...
const runnerUpGameElement = document.createElement("h3");
